...
public class ZigHandSessionDetector : MonoBehaviour {
	...
	public static string hand = string.Empty;//detected hand waving (for display)
	int lefHand = 0; int tmpLeft = 0;
	int rightHand = 0; int tmpRight = 0;
	float timer = 1;
