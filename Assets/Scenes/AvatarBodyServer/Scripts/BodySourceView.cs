...
public class BodySourceView : MonoBehaviour 
{
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        //body.transform.position = _InterfaceManager.stickmanRoot;
    ...
    private void RefreshBodyObject(Kinect.Body body, GameObject bodyObject)
    {
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            // stop
            //jointObj.localPosition = GetVector3FromJoint(sourceJoint) + _InterfaceManager.stickmanRoot;
            ...
            if(targetJoint.HasValue)
            {
                ...
                // here
                var teste = GetVector3FromJoint(targetJoint.Value) + floorPos;
                teste = rotFromFloortoKinect * teste;
                teste = teste + _InterfaceManager.stickmanRoot;
                lr.SetPosition(1, teste);
                // stop
                //lr.SetPosition(1, GetVector3FromJoint(targetJoint.Value) + _InterfaceManager.stickmanRoot);
